...
button_bed.config(command=lambda: toggle_device_yeelight(bed_device, button_bed))
...
button_bedroom_lamp.config(command=lambda: toggle_device_yeelight(edroom_lamp_device, button_bedroom_lamp))
button_bedroom_lamp.configure(bg=button_initial_color_yeelight(edroom_lamp_device))
...
button_island.config(command=lambda: toggle_device_yeelight(island_device, button_island))
...
button_livingroom_lamp.config(command=lambda: toggle_device_yeelight(livingroom_lamp_device, button_livingroom_lamp))
button_livingroom_lamp.configure(bg=button_initial_color_yeelight(livingroom_lamp_device))
...
button_kitchen.config(command=lambda: toggle_device_yeelight(kitchen_device, button_kitchen))
...
button_sufit = tk.Button(window, text="Sufit")
button_sufit.config(command=lambda: toggle_device_cuco_group(cuco_group_list, button_sufit))
